        ...
        public void NavigateTo(string pageKey, object parameter)
        {
            lock (_pagesByKey)
            {
                ...
                if (_pagesByKey.ContainsKey(pageKey))
                {
                    ...
                    ConstructorInfo consctructor;
                    object[] parameters;

                    if (parameter == null)
                    {
                        consctructor = type.GetTypeInfo()
